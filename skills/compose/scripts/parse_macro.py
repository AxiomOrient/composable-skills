...
FALLBACK_SKILL_RESPONSE_PROFILE_MAP: Dict[str, str] = {
    ...
    "doc-write-release-docs": "documentation_report",
    ...
    "tidy-apply-review-fixes": "implementation_delta",
    "commit-write-message": "commit_proposal",
    "ask-clarify-question": "clarify_question",
    ...
    "workflow-clarify-request": "question_stack",
    "workflow-review-change": "review_findings",
    ...
    "workflow-doc-build-docset": "documentation_report",
    "workflow-doc-release-package": "documentation_report",
    "workflow-tidy-simplify-this": "implementation_delta",
    "control-release-publish-flow": "generic",
