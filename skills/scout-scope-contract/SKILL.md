---
name: scout-scope-contract
description: "Use when requirements are vague and must be clarified into precise goal, scope, constraints, acceptance criteria, and explicit inclusion or exclusion boundaries. Do not use when the primary task is implementation, debugging, or deep repository analysis."
---
